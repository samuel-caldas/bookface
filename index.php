...
?>
  ...
  <div class="field">
    ...
    <div class="signup">Cadastre-se
<?php
include("config.php");
$qry = mysql_query("SELECT * FROM members");
echo " - ".mysql_num_rows($qry)." membros.";
?></div>
	<div class="free">É gratuito e sempre será.</div>
	<div class="text">
	<form action="register-exec.php" method="post">
		...
		<div class="textleft">Endereço:</div>
		...
		<div class="textleft">Telefone:</div>

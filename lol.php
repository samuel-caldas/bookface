...
mysql_close($con);
?>
            </a> <a href="editfriends.php">Edit Friend</a> <a href="editprofile.php">Account Setting</a> <a href="auto.htm">SearchFriend</a> <a href="index.php">Logout</a> </div>
        </li>
      </ul>
...
while($row = mysql_fetch_array($result))
 ...
 echo '<a href=photocomment.php?id=' . $row["photo_id"] . '>' . "<img width=80 height=80 alt='Unable to View' src='". $row["location"] . "'>" . '</a>';
...
/* echo '<table width="100" border="0" cellspacing="0" cellpadding="0">';
  ...
  echo '<tr>';
    echo '<td>';
	echo '<a href=photolist.php?id=' . $row["photo_id"] . '>' . $row['caption'] . '</a>';
	echo '</td>';
  echo '</tr>';
echo '</table>';*/
  }
...
$c = $_SESSION['SESS_LAST_NAME'];
$_SESSION['SESS_MEMBER_ID'] = $a;
$_SESSION['SESS_FIRST_NAME'] = $b;
$_SESSION['SESS_LAST_NAME'] = $c;
echo "<!-- $a - $b - $c -->";
?>
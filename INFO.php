...
<title><?php echo $_SESSION['SESS_FIRST_NAME'];?> Information</title>
...
?>
	...
	<li><a href="#" onmouseover="mopen('m4')" onmouseout="mclosetime()"><img src="images/message.png" width="16" height="12" border="0" /> &nbsp;<font color="#0000FF">Info</font></a>
		<div id="m4" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">	  </div>
	</li><br />
...
?>
	  ...
	  Arts and Entertainment</strong></div>
	  <div class="educinfo">
